...
For our example, the true $r(N)$ is linear, so an EDF near 2 would be ideal; the fit above reports an EDF of about 4, reflecting the extra flexibility LAML retains to accommodate the observation noise.
