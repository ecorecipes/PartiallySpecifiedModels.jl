...
The package builds on the [SciML ecosystem](https://sciml.ai/) and supports 23 fitting algorithms, 10 approximator types, 5 likelihood families, and 14 shape constraint types.
